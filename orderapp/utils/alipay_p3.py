...
class AliPay(object):
    ...
    def build_body(self, method, biz_content, return_url=None):
        ...
        if return_url is not None:
            data["notify_url"] = self.app_notify_url  # 使用类属性中的异步通知URL
            data["return_url"] = return_url  # 使用传入的同步通知URL，而不是类属性
    ...
    def _verify(self, raw_content, signature):
        ...
        if signer.verify(digest, base64.b64decode(signature.encode("utf8"))):  # 修正base64解码方式
            return True
        return False
...
if __name__ == '__main__':
    ...
    print('https://openapi.alipaydev.com/gateway.do?'+ali.direct_pay(
        subject='asdsad',
        total_amount='0.01',
